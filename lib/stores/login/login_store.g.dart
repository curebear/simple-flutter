...
mixin _$LoginStore on _LoginStore, Store {
  ...
  final _$postsListAtom = Atom(name: '_LoginStore.postsList');

  @override
  List<PostItem> get postsList {
  ...
  @override
  set postsList(List<PostItem> value) {
  ...
  final _$confirmPasswordAtom = Atom(name: '_LoginStore.confirmPassword');
...
mixin _$LoginErrorStore on _LoginErrorStore, Store {
  ...
  final _$confirmPasswordAtom = Atom(name: '_LoginErrorStore.confirmPassword');
